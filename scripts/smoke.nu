...
#
# TODO(crs-validate-ci): integrate `crs validate` into this smoke test and add it (#64)
# to GitHub Actions CI. It currently runs only ad-hoc. Gate: cargo build must
# succeed and crs binary must be on PATH.
#
# TODO(enrich-script-tests): add integration tests for the enrich scripts here — (#65)
...
#
# TODO(enrich-dedup-scripts): scripts/enrich-handoff.nu, enrich-handoff.sh, and (#66)
